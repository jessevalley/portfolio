...
$query22 = $dbh->prepare("SELECT * FROM USER WHERE UNAME='$uname';");
$query22->execute();
$r = $query22->fetch(PDO::FETCH_ASSOC);
...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <li><p class="navbar-text"><?php echo $uname ?> <span class="glyphicon glyphicon-user"></span></p></li>
    </ul>
  </div>
</nav>
<br /><br /><br />
<div class="container-fluid">
	<h2 class="text-center">Update Your Profile</h2>
 	<p class="text-center text-warning">* Any changes you make will be updated when you hit <strong>Save</strong>.</p>
  	<div class="row">
	  ...
	  <form class="form-horizontal" action="updateAccount.php" method="post">
		<div class="form-group">
		  ...
		  <div class="col-sm-10">
			<input type="text" class="form-control" id="fname" placeholder="<?php echo $r['FNAME']; ?>" name="fname">
		  </div>
		</div>
		<div class="form-group">
		  <label class="control-label col-sm-2" for="mname">Middle Name:</label>
		  <div class="col-sm-10">
			<input type="text" class="form-control" id="mname" placeholder="<?php echo $r['MNAME']; ?>" name="mname">
		  </div>
		</div>
		<div class="form-group">
		  <label class="control-label col-sm-2" for="lname">Last Name:</label>
		  <div class="col-sm-10">
			<input type="text" class="form-control" id="lname" placeholder="<?php echo $r['LNAME']; ?>" name="lname">
		  </div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			  ...
			  <div class="col-sm-10">
				<input type="email" class="form-control" id="email" placeholder="<?php echo $r['EMAIL']; ?>" name="email">
			  </div>
    	</div>
    	<div class="form-group">        
    	...
    	<div class="form-group">
		  ...
		  <div class="col-sm-10">
			<input type="text" class="form-control" id="street1" placeholder="<?php echo $r['STREET1']; ?>" name="street1">
		  </div>
		</div>
		<div class="form-group">
		  <label class="control-label col-sm-2" for="street2">Address:</label>
		  <div class="col-sm-10">
			<input type="text" class="form-control" id="street2" placeholder="<?php echo $r['STREET2']; ?>" name="street2">
		  </div>
		</div>
		<div class="form-group">
		  <label class="control-label col-sm-2" for="city">City:</label>
		  <div class="col-sm-10">
			<input type="text" class="form-control" id="city" placeholder="<?php echo $r['CITY']; ?>" name="city">
		  </div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
		  ...
		  <div class="col-sm-10">
			<input type="text" class="form-control" pattern="^\d{5}$" id="zip" placeholder="<?php echo $r['ZIP']; ?>" name="zip">
		  </div>
		</div>
		<div class="form-group">
		  <label class="control-label col-sm-2" for="phone_home">Home Phone:</label>
		  <div class="col-sm-10">
			<input type="tel" class="form-control" id="phone_home" placeholder="<?php echo $r['PHONE_HOME']; ?>" pattern="^\d{10}$" name="phone_home">
		  </div>
		</div>
		<div class="form-group">
		  <label class="control-label col-sm-2" for="phone_cell">Cell Phone:</label>
		  <div class="col-sm-10">
			<input type="tel" class="form-control" id="phone_cell" placeholder="<?php echo $r['PHONE_CELL']; ?>" pattern="^\d{10}$" name="phone_cell">
		  </div>
		</div>
		<div class="form-group">        
		  <div class="col-sm-offset-2 col-sm-10">
		...
		<div class="form-group">        
		  <div class="col-sm-offset-2 col-sm-10">
			<button type="submit" name="save" class="btn btn-block btn-default">Save</button>
		  </div>
		</div>
	  </form>
	  </div>
