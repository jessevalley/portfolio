...
$_SESSION['gpw4'];
$query = $dbh->prepare("SELECT * FROM file WHERE GALLERY_GID = 4 ORDER BY TITLE;");
$query->execute();
$query2 = $dbh->prepare("UPDATE GALLERY SET NUM_VIEWS = (NUM_VIEWS + 1) WHERE GID = 4;)");
$query2->execute();
$query2 = null;
$stmt = $dbh->prepare('SELECT * FROM gallery WHERE GID = 4');
$stmt->execute();
$views = $stmt->fetch(PDO::FETCH_ASSOC);
$logged = $views['LOGGED_IN'];
$views2 = $views['NUM_VIEWS'];
$gpw = $views['GPW'];
$pwmatch = $_SESSION['gpw4'];
$gid = $views['GID'];
$_SESSION['gpw']=$gpw;
$role = $_SESSION['admin'];
$uid = $_SESSION['uid'];
...
<html lang="en">
<head>
  <title>The Pottery of Jesse Valley</title>
  <meta charset="utf-8">
  <meta name="description" content="Pottery of Jesse Valley">
  <meta name="keywords" content="Pottery, Sculpture, Art, Portfolio, Jesse Valley">
...
.parallax {
    /* The image used */
    background-image: url("img/pots.jpg");
...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <p class="navbar-text" id="navtext">The Pottery of Jesse Valley</p>
    </div>
...
<h3 class="text-center">Pottery & Sculpture</h3>
</div>
<div class="parallax">
	<div class="caption">
...
<form name="contactform" method="post" action="send_form_email.php">
  ...
  <div class="modal fade" id="signup" role="dialog">
   ...
   <h2> </h2>
  <br /><br />
    <h3 class="text-center">Portfolio of Pottery & Sculpture</h3>
			...
			while($row1=$query->fetch(PDO::FETCH_ASSOC)){
				...
				<div class="column">
					<div class="content">
						...
						<img src="img/<?php echo $row1['FILE_NAME']; ?>" alt="<?php echo $name; ?>"></a>
