...
$_SESSION['gpw6'];
$query = $dbh->prepare("SELECT * FROM file WHERE GALLERY_GID = 6 ORDER BY TITLE;");
$query->execute();
$query2 = $dbh->prepare("UPDATE GALLERY SET NUM_VIEWS = (NUM_VIEWS + 1) WHERE GID = 6;)");
$query2->execute();
$query2 = null;
$stmt = $dbh->prepare('SELECT * FROM gallery WHERE GID = 6');
$stmt->execute();
$views = $stmt->fetch(PDO::FETCH_ASSOC);
$logged = $views['LOGGED_IN'];
$views2 = $views['NUM_VIEWS'];
$gpw = $views['GPW'];
$pwmatch = $_SESSION['gpw6'];
$gid = $views['GID'];
$_SESSION['gpw']=$gpw;
$role = $_SESSION['admin'];
$uid = $_SESSION['uid'];
...
<html lang="en">
<head>
  <title>The Portraiture of Jesse Valley</title>
  <meta charset="utf-8">
  <meta name="description" content="Photography of Jesse Valley">
  <meta name="keywords" content="Photography, Portraits, Portraiture, Portfolio, Jesse Valley">
...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <p class="navbar-text" id="navtext">The Portraiture of Jesse Valley</p>
    </div>
...
<h3 class="text-center">Portraiture</h3>
</div>
<div class="parallax">
	<div class="caption">
...
<form name="contactform" method="post" action="send_form_email.php">
  ...
  <div class="modal fade" id="signup" role="dialog">
   ...
   <h2> </h2>
  <br /><br />
    <h3 class="text-center">Portfolio of Portraits</h3>
