...
$_SESSION['gpw2'];
$query = $dbh->prepare("SELECT * FROM file WHERE GALLERY_GID = 2 ORDER BY TITLE;");
$query->execute();
$query2 = $dbh->prepare("UPDATE GALLERY SET NUM_VIEWS = (NUM_VIEWS + 1) WHERE GID = 2;)");
$query2->execute();
$query2 = null;
$stmt = $dbh->prepare('SELECT * FROM gallery WHERE GID = 2');
$stmt->execute();
$views = $stmt->fetch(PDO::FETCH_ASSOC);
$logged = $views['LOGGED_IN'];
$views2 = $views['NUM_VIEWS'];
$gpw = $views['GPW'];
$pwmatch = $_SESSION['gpw2'];
$gid = $views['GID'];
$_SESSION['gpw']=$gpw;
$role = $_SESSION['admin'];
$uid = $_SESSION['uid'];
...
<html lang="en">
<head>
  <title>The Poetry of Jesse Valley</title>
  <meta charset="utf-8">
  <meta name="description" content="Poems of Jesse Valley">
  <meta name="keywords" content="Poetry, Poems, Portfolio, Jesse Valley">
...
.parallax {
    /* The image used */
    background-image: url("img/its_telling.png");
...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <p class="navbar-text" id="navtext">The Poetry of Jesse Valley</p>
    </div>
...
<h3 class="text-center">Poetry</h3>
</div>
<div class="parallax">
	<div class="caption">
...
<form name="contactform" method="post" action="send_form_email.php">
  ...
  <div class="modal fade" id="signup" role="dialog">
   ...
   <h2> </h2>
  <br /><br />
    <h3 class="text-center">Portfolio of Poems</h3>
