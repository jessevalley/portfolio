...
$_SESSION['gpw5'];
$query = $dbh->prepare("SELECT * FROM FILE WHERE GALLERY_GID = 5 ORDER BY TITLE;");
$query->execute();
$query2 = $dbh->prepare("UPDATE GALLERY SET NUM_VIEWS = (NUM_VIEWS + 1) WHERE GID = 5;)");
$query2->execute();
$query2 = null;
$stmt = $dbh->prepare('SELECT * FROM GALLERY WHERE GID = 5');
$stmt->execute();
$views = $stmt->fetch(PDO::FETCH_ASSOC);
$logged = $views['LOGGED_IN'];
$views2 = $views['NUM_VIEWS'];
$gpw = $views['GPW'];
$pwmatch = $_SESSION['gpw5'];
$gid = $views['GID'];
$_SESSION['gpw']=$gpw;
$role = $_SESSION['admin'];
$uid = $_SESSION['uid'];
...
<html lang="en">
<head>
  <title>The Programming of Jesse Valley</title>
  <meta charset="utf-8">
  <meta name="description" content="Web Programming of Jesse Valley">
  <meta name="keywords" content="Programming, Web Design, Database Development, Portfolio, Jesse Valley">
...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <p class="navbar-text" id="navtext">The Programming of Jesse Valley</p>
    </div>
...
<h3 class="text-center">Web Programming & Database Development</h3>
</div>
<div class="parallax">
	<div class="caption">
...
<form name="contactform" method="post" action="send_form_email.php">
  ...
  <div class="modal fade" id="signup" role="dialog">
   ...
   <h2> </h2>
  <br /><br />
    <h3 class="text-center">Portfolio of Programming Projects</h3>
